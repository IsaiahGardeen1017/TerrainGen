...
vec3 mixOcean(float a) {
    vec3 collo = vec3(n255(149.0), n255(3.0), n255(0.0));
    vec3 colhi = vec3(n255(207.0), n255(73.0), n255(0.0));
    return mix(collo, colhi, 0.0 - a);
}

vec3 mixLand(float a) {
    vec3 collo = vec3(n255(131.0), n255(77.0), n255(32.0));
    vec3 colhi = vec3(n255(181.0), n255(150.0), n255(130.0));
